...
describe('company/people/onboarding/create', () => {
  describe('when create new hire PEO SG', () => {
    before(() => {
    ...
    describe('when filling step by step', () => {
      it('should complete hiring details', () => {
        ...
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-currency"]'
        )
          .click()
          .type('SGD');
        ...
        cy.get(
          ...
          .find('input');
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-salaryPayableDate"]'
        ).click();
        cy.get(
          `[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-salaryPayableDate-optionId-27"]`
        ).click();
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEligibleForAdditionalIncome"]'
        ).click();
        cy.get(
          `[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEligibleForAdditionalIncome-optionId-0"]`
        ).click();
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEligibleForPaidExpenses"]'
        ).click();
        cy.get(
          `[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEligibleForPaidExpenses-optionId-0"]`
        ).click();
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEntitledToOvertime"]'
        ).click();
        cy.get(
          `[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-isEntitledToOvertime-optionId-0"]`
        ).click();
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-nextButton"]'
        ).click();
        ...
        cy.get(
          ...
          .should('have.value', '1');
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-additionalDetails-isEligibleForInsurance"]'
        ).click();
        cy.get(
          `[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-additionalDetails-isEligibleForInsurance-optionId-0"]`
        ).click();
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-nextButton"]'
        ).click();
