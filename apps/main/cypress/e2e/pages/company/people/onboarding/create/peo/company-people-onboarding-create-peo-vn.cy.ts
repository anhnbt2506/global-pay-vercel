...
describe('company/people/onboarding/create', () => {
  describe('when create new hire PEO Vietnam', () => {
    before(() => {
    ...
    describe('when filling step by step', () => {
      it('should complete hiring details', () => {
        ...
        cy.chooseDatePicker(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-additionalDetails-probationStartDate"]',
          '1'
        );
        cy.chooseDatePicker(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-additionalDetails-probationEndDate"]',
          '2'
        );
        cy.get(
