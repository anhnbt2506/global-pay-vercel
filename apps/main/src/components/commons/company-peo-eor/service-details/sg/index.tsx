    ...
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.sg.payrollCycle.label')}
          helperText={t('serviceDetail.form.sg.payrollCycle.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.sg.payrollDate.label')}
          helperText={t('serviceDetail.form.sg.payrollDate.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.sg.prorateSalaryFormula.label')}
          helperText={t(
            'serviceDetail.form.sg.prorateSalaryFormula.helperText'
          )}
