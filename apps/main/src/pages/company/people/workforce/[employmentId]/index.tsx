...
interface CompanyPeopleWorkforceEmploymentIdProps {
...
const CompanyPeopleWorkforceEmploymentId: NextPage<
  CompanyPeopleWorkforceEmploymentIdProps
> = ({
  isDesktop,
  session,
  countries,
  ...
  const { t } = useTranslation('company-people-workforce-employment-id');
  ...
  return (
    <AppLayout isDesktop={isDesktop} pageName={t('pageName')}>
      <CompanyEmploymentDetails
        ...
        setToast={setToast}
        dataTestId="companyPeopleWorkforce-employmentId"
      />
      <Toast
        open={!!toast.message}
        severity={toast.severity}
        onClose={() => setToast({ message: '' })}
        dataTestId="companyPeopleWorkforce-employmentId-toast"
      >
        {toast.message}
      </Toast>
    </AppLayout>
...
export default CompanyPeopleWorkforceEmploymentId;
...
> = async (context) => {
  try {
    ...
    return {
      props: {} as CompanyPeopleWorkforceEmploymentIdProps,
    };
  }
};
