...
describe('worker/onboarding', () => {
  ...
  describe('when worker has invited', () => {
    ...
    const fillStep2 = () => {
      ...
      cy.get(
        '[data-testid="workerOnboarding-identification-field-additionalInfo.cpfNumber"]'
      )
        .type('323122')
        .find('input')
        .should('have.value', '323122');
    ...
    const fillStep5 = () => {
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-workerIdentity.nationalIdFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-workerIdentity.nationalIdFile"]'
      ).clickOutside();
    ...
    before(() => {
      ...
      cy.mocksUseRouteVariant(
        'people/v1/worker-employment/get-by-employment-id:200-employee-invited-status-sg'
      );
  ...
  describe('when worker inreview', () => {
    before(() => {
      ...
      cy.mocksUseRouteVariant(
        'people/v1/worker-employment/get-by-employment-id:200-employee-review-status-sg'
      );
      signInWorker();
