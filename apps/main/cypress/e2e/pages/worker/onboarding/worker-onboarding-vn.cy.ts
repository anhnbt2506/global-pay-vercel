  ...
  describe('when worker has invited', () => {
    ...
    const fillStep2 = () => {
      cy.get(
        ...
        .type('123456abc')
        .find('input')
        .should('have.value', '123456abc');

      cy.chooseDatePicker(
        '[data-testid="workerOnboarding-identification-field-workerIdentity.nationalIdIssuedDate"]',
        '1'
      );
      cy.get(
    ...
    before(() => {
      ...
      cy.mocksUseRouteVariant(
        'people/v1/worker-employment/get-by-employment-id:200-employee-invited-status-vn'
      );
