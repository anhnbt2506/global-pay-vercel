...
describe('company/people/onboarding/create', () => {
  describe('when create new hire PEO Indonesia', () => {
    before(() => {
    ...
    describe('when filling step by step', () => {
      it('should complete hiring details', () => {
        ...
        cy.get(
          '[data-testid="companyPeopleOnboardingCreate-guidedMode-peo-field-additionalDetails-religiousFestivityAllowance"]'
        )
          .type('11')
          .find('input');
        cy.get(
