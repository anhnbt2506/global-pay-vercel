    ...
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.th.payrollCycle.label')}
          helperText={t('serviceDetail.form.th.payrollCycle.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.th.payrollDate.label')}
          helperText={t('serviceDetail.form.th.payrollDate.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.th.prorateSalaryFormula.label')}
          helperText={t(
            'serviceDetail.form.th.prorateSalaryFormula.helperText'
          )}
