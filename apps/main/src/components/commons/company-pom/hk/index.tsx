...
import HkFormFields from './form-fields';

interface CompanyPomHkFormProps {
...
const CompanyPomHkForm: FC<CompanyPomHkFormProps> = ({
  ...
  const onSubmitForm = async (
    ...
    fireGtmEvent<GTM_EVENTS>({
      event: GTM_EVENTS.CLIENT_PORTAL_ADD_POM_SERVICE_HK_DONE,
    });
  };
      ...
      <Form noValidate>
        ...
        >
          <Button
            ...
            onClick={() => {
              fireGtmEvent<GTM_EVENTS>({
                event: GTM_EVENTS.CLIENT_PORTAL_ADD_POM_SERVICE_HK_LEAVE,
              });
              onClose();
            }}
            sx={{
...
export default CompanyPomHkForm;
