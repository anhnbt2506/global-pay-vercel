...
describe('worker/onboarding', () => {
  ...
  describe('when worker has invited', () => {
    ...
    const fillStep5 = () => {
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.familyCardFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.npwpCardFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.bpjsKetenagakerjaanCardFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.bpjsKesehatanCardFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.nationalIdFile"]'
      ).attachFile('test.pdf');
      cy.get(
        '[data-testid="workerOnboarding-additionalInformation-field-additionalInfo.numberOfChildren"]'
      )
        .type('85377884411')
        .find('input');
    ...
    before(() => {
      ...
      cy.mocksUseRouteVariant(
        'people/v1/worker-employment/get-by-employment-id:200-employee-invited-status'
      );
