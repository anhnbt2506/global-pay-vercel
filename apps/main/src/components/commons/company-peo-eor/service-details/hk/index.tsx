    ...
    <Grid container spacing={2}>
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.hk.payrollCycle.label')}
          helperText={t('serviceDetail.form.hk.payrollCycle.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.hk.payrollDate.label')}
          helperText={t('serviceDetail.form.hk.payrollDate.helperText')}
      ...
      <Grid item xs={12}>
        <Select
          ...
          label={t('serviceDetail.form.hk.prorateSalaryFormula.label')}
          helperText={t(
            'serviceDetail.form.hk.prorateSalaryFormula.helperText'
          )}
